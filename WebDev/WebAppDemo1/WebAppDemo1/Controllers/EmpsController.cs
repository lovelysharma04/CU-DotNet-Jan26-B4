...
namespace WebAppDemo1.Controllers
{
    public class EmpsController : Controller
    {
        ...
        public EmpsController(WebAppDemo1Context context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("EmpId,EmpName,City,Salary")] Emp emp)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("EmpId,EmpName,City,Salary")] Emp emp)
        {
            if (id != emp.EmpId)
            {
                return NotFound();
